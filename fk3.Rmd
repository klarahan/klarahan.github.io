...
# 
# rm(cses_imd)
# saveRDS(cses_all, "data/cses_korea.RDS")
```

Further prepare CSES survey data.
```{r include=FALSE}
cses_all <- readRDS("data/cses_korea.RDS")
a <- cses_all %>% 
...
ggplot(a) +
  ...
  facet_grid(.~govt_short) +
  labs(caption = "CSES IMD survey items from the years 2000, 2004, 2008, 2012 (1656 observations)
       Governments: Liberal = 2004 and 2008, Conservative = 2000 and 2012
