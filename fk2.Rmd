...
setwd("C:/Users/hanou/Dropbox/0 MYCOMP/0_Book manuscript/Lexington/klarahan.github.io")
# setwd("~/Dropbox/0 MYCOMP/0_Book manuscript/Lexington/klarahan.github.io")
# setwd("C:/Users/han/Dropbox/0 MYCOMP/0_Book manuscript/Lexington/klarahan.github.io")
...
Show term frequency ranks for the most negative administrations.
```{r}
news_words %>% 
  filter(Newspaper == "Hankyoreh") %>% 
  filter(admin %in% c("2013-2014 Park GH", "1990-1993 Roh TW")) %>% 
